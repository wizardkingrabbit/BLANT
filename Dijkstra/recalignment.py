...
def rec_alignhelper(cg1, cg2, g1, g2, curralign, candidatePairs, aligncombs, sims, debug):
    ...
    while(True): 
        try:
            ...
            rec_alignhelper(cg1, cg2, g1,g2, curralign, candidatePairs.union(newcandidatePairs), aligncombs, sims, debug)
...
def rec_align(cg1, cg2, g1, g2, seed, sims, ec_mode, ed, m, sb, delta, alpha, seednum, outputdir, alignstop, timestop=None,  debug=False):
    ...
    rec_alignhelper(cg1, cg2, g1, g2, curralign, candidatePairs, aligncombs, sims, debug)
