...
if __name__ == '__main__':
    ...
    while True:
        ...
        if simbound > 0:
            ...
            recalignment.rec_align(c_graph_a, c_graph_b, graph1, graph2, seed, sims, ec_mode, ed, e1, simbound, delta, alpha, seednum, args.outputdir, alignstop=args.alignstop, timestop=timestop_arg, debug=args.debugval)
        ...
        print("this loop takes -> " + str(time.time() - timestamp))
